...
int fast_muon_correlation_comparison(const char* filepath_cdwpttchi2, const char* filepath_amber) {
    ...
    float charge;
    chain_amber->SetBranchAddress("runID", &runID);
    chain_amber->SetBranchAddress("eventID", &eventID);
    chain_amber->SetBranchAddress("fSec", &fSec);
    chain_amber->SetBranchAddress("fNanoSec", &fNanoSec);
    chain_amber->SetBranchAddress("muonType", &muonType);
    chain_amber->SetBranchAddress("xin", &xin);
    chain_amber->SetBranchAddress("yin", &yin);
    chain_amber->SetBranchAddress("zin", &zin);
    chain_amber->SetBranchAddress("xout", &xout);
    chain_amber->SetBranchAddress("yout", &yout);
    chain_amber->SetBranchAddress("zout", &zout);
    chain_amber->SetBranchAddress("charge", &charge);
