...
void no_good_tt_maches(const char* filename) {
    ...
    for (int k = 0; k < tree->GetEntries(); ++k) {
        ...
        if (NTotPoints < 2 /* == 0 */) {
            ...
            bool is_in_layer = (
                (std::abs(cdwp_reco_x_at_layer[0]) <= 23500.0 && std::abs(cdwp_reco_y_at_layer[0]) <= 10000.0) &&
                (std::abs(cdwp_reco_x_at_layer[1]) <= 23500.0 && std::abs(cdwp_reco_y_at_layer[1]) <= 10000.0) &&
                (std::abs(cdwp_reco_x_at_layer[2]) <= 23500.0 && std::abs(cdwp_reco_y_at_layer[2]) <= 10000.0)
            );
            bool is_in_chimney = (
                (std::abs(cdwp_reco_x_at_layer[0]) <= 3350.0 && std::abs(cdwp_reco_y_at_layer[0]) <= 3350.0) ||
                (std::abs(cdwp_reco_x_at_layer[1]) <= 3350.0 && std::abs(cdwp_reco_y_at_layer[1]) <= 3350.0) ||
                (std::abs(cdwp_reco_x_at_layer[2]) <= 3350.0 && std::abs(cdwp_reco_y_at_layer[2]) <= 3350.0)
            );
