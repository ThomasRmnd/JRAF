...
parser.add_argument("--first-reconstruction-file", action="store_true", help="First reconstruction file")
...
alg.property("FirstReconstructionFile").set(args.first_reconstruction_file)
